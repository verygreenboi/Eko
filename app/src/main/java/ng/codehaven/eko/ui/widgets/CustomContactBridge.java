package ng.codehaven.eko.ui.widgets;
 ...
 */
public class CustomContactBridge extends QuickContactBadge {
    ...
    public CustomContactBridge(Context context) {
        super(context);
    }

    public CustomContactBridge(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomContactBridge(Context context, AttributeSet attrs, int defStyleAttr) {
